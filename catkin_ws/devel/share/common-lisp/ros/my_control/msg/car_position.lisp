...
(cl:defmethod cl:initialize-instance :after ((m <car_position>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'car_position)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_control-msg:<car_position> is deprecated: use my_control-msg:car_position instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <car_position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_control-msg:x-val is deprecated.  Use my_control-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <car_position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_control-msg:y-val is deprecated.  Use my_control-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'theta-val :lambda-list '(m))
(cl:defmethod theta-val ((m <car_position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_control-msg:theta-val is deprecated.  Use my_control-msg:theta instead.")
  (theta m))

(cl:ensure-generic-function 'v-val :lambda-list '(m))
(cl:defmethod v-val ((m <car_position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_control-msg:v-val is deprecated.  Use my_control-msg:v instead.")
  (v m))
